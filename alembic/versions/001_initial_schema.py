...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "cost_budget_usd_monthly", sa.Numeric(10, 4), nullable=False, server_default="50.00"
        ),
        sa.Column(
            "cost_spent_usd_current_month", sa.Numeric(10, 4), nullable=False, server_default="0"
        ),
        sa.Column(
